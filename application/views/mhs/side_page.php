        ...
        <div class="col-sm-3">
          <div class="row">
          <img src="<?=base_url()?>assets/upload/foto_profil/<?php echo $foto;?>" style="width: 140px; height: 180px; margin-left: 60px; border: 3px solid #DAA520; margin-left: 90px;">
            ...
            <div class="col-sm-12">
               <div class="list-group">
                  <ul style="list-style-type: none;">
                   ...
                   <li class="list-group-item"><a href="<?=base_url()?>index.php/KP/cetaksurat_page/<?php echo $id;?>" style="color: #555; text-decoration: none; display: block;">Cetak Surat</a></li>
