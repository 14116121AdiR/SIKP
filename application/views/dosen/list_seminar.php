    ...
    <?php $this->load->view('navigation'); ?>
      ...
      <div class="row">
        ...
        <?php $this->load->view('dosen/side_page'); ?>
          ...
          <div class = "title1">
            <p>List Pendaftar Seminar KP</p>
          </div>
          <div class = "art1">
            <table class="table">
              <tr>
                <th width="200px">Nama</th>
                <th width="300px">Judul Seminar</th>
                <th width="100px">Tanggal</th>
                <th width="100px">Ruang</th>
                <th width="100px">Validasi</th>
              </tr>
                  <?php      
                  foreach ($this->session->userdata('datasem') as $r){ ?>
                  <tr>
                    <td><?php echo $r['nama'] ?></td>
                    <td><?php echo $r['judul_seminar']  ?></td>
                    <td><?php echo $r['tanggal_seminar'] ?></td>
                    <td><?php echo $r['ruang']?></td>
                    <td><?php echo $r['status_validasi']?></td> 
                    <td><form action="<?php echo site_url('KP/dataseminar/'. $r['nim']) ?>">
