...
<head>
 ...
 <body style="background: url(<?=base_url()?>assets/img/bgg.jpg); background-size: 100%;">
  ...
  <div class="row">
    ...
    <p>Jangan memberikan akun login (nama pengguna dan kata sandi) anda pada siapapun.
   ...
   <div class="box">
        ...
        <form class="fl" action="<?=base_url()?>index.php/KP/login  " method="post">
          ...
          <div class="alert" style="background: red; width: 282px; height: 70px; font-size: 14px; margin-left: 143px; margin-top: -100px; color: white">
